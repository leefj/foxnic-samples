...
public class AddressVO extends Address {
	...
	*/
	...
	public AddressVO duplicate(boolean all) {
		com.leefj.foxnic.sql.demo.app.domain.example.meta.AddressVOMeta.$$proxy$$ inst = new com.leefj.foxnic.sql.demo.app.domain.example.meta.AddressVOMeta.$$proxy$$();
	...
	*/
	...
	public static AddressVO create() {
		return new com.leefj.foxnic.sql.demo.app.domain.example.meta.AddressVOMeta.$$proxy$$();
	}
