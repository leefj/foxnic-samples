...
import com.leefj.foxnic.sql.demo.app.domain.example.meta.OrderItemVOMeta;
...
public class OrderItemVO extends OrderItem {
	...
	*/
	...
	public OrderItemVO duplicate(boolean all) {
		com.leefj.foxnic.sql.demo.app.domain.example.meta.OrderItemVOMeta.$$proxy$$ inst = new com.leefj.foxnic.sql.demo.app.domain.example.meta.OrderItemVOMeta.$$proxy$$();
	...
	*/
	...
	public static OrderItemVO create() {
		return new com.leefj.foxnic.sql.demo.app.domain.example.meta.OrderItemVOMeta.$$proxy$$();
	}
