...
layui.define(['form', 'table', 'util', 'settings', 'admin', 'upload','foxnic','xmSelect','laydate','foxnicUpload','dropdown'],function () {
    ...
    var list={
        ...
        openItems:function (data){
            console.log('openItems',data);
            admin.putVar("webfull-example-order-item-orderId",data.id);
            admin.popupCenter({
                title: "订单明细",
                resize: false,
                offset: [null,null],
                area: ["1200px","75%"],
                type: 2,
                id:"webfull-example-order-item-win",
                content: '/business/webfull-example/order_item/order_item_list.html?orderId='+data.id,
                finish: function () {
