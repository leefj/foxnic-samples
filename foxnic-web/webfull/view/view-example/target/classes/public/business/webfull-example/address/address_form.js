...
function FormPage() {
	...
	function renderFormFields() {
		...
		form.on('checkbox(regionLocation)', function(data){
			var checked=[];
			$('input[type=checkbox][lay-filter=regionLocation]:checked').each(function() {
				checked.push($(this).val());
			});
			window.pageExt.form.onCheckBoxChanged && window.pageExt.form.onCheckBoxChanged("regionLocation",data ,checked);
		});
	}
